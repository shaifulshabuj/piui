...
//#endregion
//#region src/context/NavContext.tsx
...
function useNav() {
	const ctx = (0, import_react.useContext)(NavContext);
...
var useChatStore = create((set, get) => ({
	...
	sendPrompt: (text) => {
		...
		if (window.pi) window.pi.send({
			...
			const words = "This is a mock pi response. In Electron mode, real responses stream here from pi --mode rpc.".split(" ");
			let i = 0;
			const tick = setInterval(() => {
				if (i < words.length) get().appendDelta(id, (i === 0 ? "" : " ") + words[i++]);
				else {
					clearInterval(tick);
	...
	appendDelta: (id, text) => {
		set((s) => ({ messages: s.messages.map((m) => m.id === id ? {
			...m,
	...
	addToolCall: (tc) => {
		set((s) => ({ toolCalls: [...s.toolCalls, {
			...tc,
			expanded: false
		}] }));
	},
	updateToolCall: (id, update) => {
		set((s) => ({ toolCalls: s.toolCalls.map((tc) => tc.id === id ? {
			...tc,
			...update
		} : tc) }));
	},
	...
	setQueueCounts: (steering, followUp) => {
		set({
	...
	setStreaming: (v) => {
		set((s) => {
			if (!v && s.streamingId) return {
				isStreaming: false,
				streamingId: null,
				messages: s.messages.map((m) => m.id === s.streamingId ? {
					...m,
					streaming: false
				} : m)
			};
...
//#endregion
//#region src/store/modelStore.ts
var MOCK_MODELS = [
	{
		provider: "anthropic",
...
//#endregion
//#region src/store/permissionStore.ts
var usePermissionStore = create((set) => ({
	current: null,
	setRequest: (req) => set({ current: req }),
	clearRequest: () => set({ current: null })
}));
//#endregion
//#region src/store/commandsStore.ts
var useCommandsStore = create((set) => ({
	commands: [],
	isLoaded: false,
	load: () => {
...
function setupEventHandler() {
	...
	return window.pi.onEvent((raw) => {
		...
		switch (e.type) {
			case "message_start":
				chat.startAssistantMessage(e.id);
				break;
			case "message_update": {
				const msg = e.message;
				if (msg) {
					const deltaText = (msg.content ?? []).filter((c) => c.type === "text_delta").map((c) => c.text ?? "").join("");
					if (deltaText) chat.appendDelta(msg.id, deltaText);
				}
				break;
			}
			case "message_end":
				chat.finalizeMessage(e.id);
				break;
			case "tool_execution_start":
				chat.addToolCall({
					id: e.toolExecutionId,
					tool: e.name,
			...
			case "tool_execution_update":
				chat.updateToolCall(e.toolExecutionId, { output: e.output });
				break;
			case "tool_execution_end":
				chat.updateToolCall(e.toolExecutionId, {
					status: e.error ? "err" : "ok",
					output: e.output
				});
				break;
			case "queue_update":
				chat.setQueueCounts(e.steeringCount ?? 0, e.followUpCount ?? 0);
				break;
			...
			case "auto_retry_start":
				chat.setRetrying(true, e.attempt ?? 1);
				break;
			case "auto_retry_end":
			...
			case "usage":
				...
				break;
			case "model_changed":
				model.setCurrentModel(e.model);
				break;
			case "models_list":
				model.setModels(e.models);
				break;
			case "response": {
				const cmd = e.command;
				if (cmd === "get_commands") {
					const data = e.data;
					if (data?.commands) commands.setCommands(data.commands.map((c) => ({
						name: c.name,
					...
					const data = e.data;
					if (data?.sessionFile) chat.setSessionFile(data.sessionFile);
				}
				break;
			}
		}
...
//#endregion
//#region src/components/primitives/index.tsx
...
function Dot({ color = T.ok, size = 6, animated = false, style = {} }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: {
		...
		flexShrink: 0,
		animation: animated ? "pi-pulse 1.2s ease-in-out infinite" : void 0,
		...style
	} });
}
function Btn({ children, variant = "ghost", icon, kbd, style = {}, full, disabled, onClick }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
		...
		children: [
			...
			kbd && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				style: {
					marginLeft: "auto",
					opacity: .6
				},
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Kbd, { children: kbd })
			})
		]
	});
}
...
function PiTitlebar({ title }) {
	...
	const dot = (bg) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: {
		width: 11,
		height: 11,
		borderRadius: "50%",
		background: bg
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			isElectron ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: 68 } }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				style: {
					display: "flex",
					gap: 7,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pi, { size: 13 }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					style: {
						fontFamily: F.mono,
						fontSize: 12,
						color: T.textDim,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { width: 52 } })
		]
	});
}
...
function PiWindow({ title, children, statusbar }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		style: {
			width: "100vw",
			height: "100vh",
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PiTitlebar, { title }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				style: {
					flex: 1,
					display: "flex",
			...
			statusbar !== void 0 ? statusbar : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PiStatusbar, {})
		]
	});
}
...
//#endregion
//#region src/components/chat/index.tsx
...
function MessageAssistant({ children, streaming }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pi, { size: 13 })
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			style: {
				flex: 1,
				fontFamily: F.mono,
			...
			children: [children, streaming && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: {
				display: "inline-block",
				width: 7,
				height: 14,
				background: T.pi,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1 } }),
				output && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					style: {
						color: T.textMuted,
						fontSize: 10.5
					},
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				children: "also: write a migration test for v0→v2 sessions"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Kbd, { children: "Alt+↵" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				style: {
					color: T.piDim,
					cursor: "pointer"
...
function Composer({ onCommandPalette, onSubmit, usage }) {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pill, {
						...
						children: "@src/session/migrate.ts"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1 } }),
					usage && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						style: {
							fontFamily: F.mono,
							fontSize: 10,
							color: T.textMuted
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [messages.length, " turns"] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1 } }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, {
							variant: "ghost",
							icon: "+",
							onClick: () => rpc.newSession(),
							children: "New"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, {
							variant: "ghost",
				...
				isCompacting && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					style: {
						padding: "6px 24px",
						background: `${T.pi}18`,
					...
					children: "⊙ Compacting session history…"
				}),
				isRetrying && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					style: {
						padding: "6px 24px",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [messages.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, { onSend: sendPrompt }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
						messages.map((msg) => {
							if (msg.role === "user") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageUser, { children: msg.content }, msg.id);
							return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageAssistant, {
								streaming: msg.streaming,
								children: msg.content
							}, msg.id);
						}),
						toolCalls.map((tc) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToolCall, {
							tool: tc.tool,
							args: tc.args,
							status: tc.status,
							output: tc.output
						}, tc.id)),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SteeringQueue, {})
					] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { height: 14 } })]
				}),
...
//#endregion
//#region src/screens/Onboarding.tsx
function OnboardingTab({ label, active }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		style: {
			padding: "6px 14px",
			borderRadius: 5,
...
function InstallBlock({ active, cmd }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		style: {
...
function Onboarding() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PiWindow, {
		title: "pi · first run",
		statusbar: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			style: {
				height: 24,
				flexShrink: 0,
				display: "flex",
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "step 2 of 4" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "·" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "this only runs the first time" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1 } }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					style: { color: T.textFaint },
					children: "v0.18.2"
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: "There are many agent harnesses."
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							style: {
								fontFamily: F.sans,
								fontSize: 32,
						...
						children: "Pi is a minimal terminal coding harness. Bring your own models, tools, and workflows — adapt pi to how you work, not the other way around."
					})] })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					style: {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(OnboardingTab, { label: "1 · install" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							style: {
								color: T.textFaint,
								alignSelf: "center"
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(OnboardingTab, {
							label: "2 · connect a model",
							active: true
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							style: {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(OnboardingTab, { label: "3 · pick a project" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							style: {
								color: T.textFaint,
								alignSelf: "center"
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(OnboardingTab, { label: "4 · first session" })
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					style: {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								style: { color: T.pi },
								children: "# "
							}), "connect at least one provider — you can add more anytime"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								display: "flex",
								flexDirection: "column",
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										style: { color: T.textFaint },
										children: "+ 11 more:"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Azure · Bedrock · Mistral · Cerebras · xAI · Hugging Face · Kimi · MiniMax · …" })]
								})
							]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InstallBlock, {
							active: "curl",
							...
							].map(([k, c, h]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								style: {
									padding: "8px 10px",
									borderRadius: 5,
									border: `1px solid ${T.border}`,
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: "2 connected · skip and add later anytime"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, {
							variant: "outline",
							children: "Skip"
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				style: {
					...
					fontFamily: F.mono,
					fontSize: 10,
					color: current ? "#1a1408" : T.textDim,
					fontWeight: 600
				},
				children: glyph
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						branch && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Pill, {
							color: T.info,
							bg: T.infoBg,
							border: "rgba(122,166,216,0.25)",
							children: ["⎇ ", branch]
						}),
						bookmark && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Pill, {
							color: T.warn,
							bg: T.warnBg,
							border: "rgba(224,178,87,0.25)",
							children: ["★ ", bookmark]
						}),
						current && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pill, {
							color: T.pi,
							bg: T.piBg,
							border: T.piBorder,
							children: "HEAD"
						...
						tokens && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							style: {
								fontFamily: F.mono,
								fontSize: 10,
								color: T.textFaint
...
//#endregion
//#region src/screens/ModelPicker.tsx
function ModelRow({ provider, name, ctx, price, fav, current, status, tags, onClick }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		onClick,
		style: {
			display: "grid",
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						tags?.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pill, {
							color: T.textMuted,
							bg: T.bgPanel,
							border: T.border,
							children: t
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				children: status === "ready" ? "● ready" : status === "rate" ? "● rate-limited" : "○ no key"
			})
		]
	});
}
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Pill, { children: [models.length, " models"] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1 } }),
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								" set key ",
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Kbd, { children: "o" }),
								" oauth ",
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Kbd, { children: "i" }),
								" info",
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1 } }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["defined in ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									style: { color: T.info },
									children: "~/.pi/models.json"
								})] }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, {
									variant: "ghost",
									icon: "✎",
									children: "Edit models.json"
								})
							]
						})
					]
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: "pi install npm:@author/name · pi install git:github.com/user/repo"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1 } }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, {
							variant: "outline",
							icon: "↗",
							children: "Browse pi.dev/packages"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, {
							variant: "secondary",
							icon: "✎",
					...
					children: [
						[
							...
							["prompts", "24"],
							["themes", "13"]
						].map(([k, c, a]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							onClick: () => k === "themes" ? navigate("theme") : void 0,
							style: {
								padding: "6px 12px",
								borderRadius: 5,
								fontFamily: F.mono,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "⌕" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "search packages…" })]
						})
					]
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: "install from anywhere"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						style: {
							display: "grid",
						...
						children: [
							[
								"npm",
								"pi install npm:@earendil/sub-agents",
								"verified, semver, signed"
							],
							[
								"git",
							...
							[
								"url",
								"pi install https://example.com/pkg.tar.gz",
								"tarball with manifest"
							]
						].map(([k, c, h]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								padding: "10px 14px",
...
//#endregion
//#region src/screens/ExtensionDetail.tsx
function TabItem({ label, active }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		style: {
			...
			fontSize: 11.5,
			color: active ? T.text : T.textDim,
			borderBottom: `2px solid ${active ? T.pi : "transparent"}`,
			cursor: "pointer"
		},
		children: label
	});
...
//#endregion
//#region src/screens/PromptTemplates.tsx
...
var BUILTIN_TEMPLATES = [
	{
		name: "commit",
		slash: "/commit",
		description: "Conventional commit from staged diff",
		source: "builtin"
	},
	{
		name: "pr",
	...
	},
	{
		name: "plan",
		slash: "/plan",
		description: "Multi-step task plan",
		source: "builtin"
	},
	{
		name: "review",
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMain, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pill, { children: "AGENTS.md · SYSTEM.md" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1 } }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						style: {
							fontFamily: F.mono,
						...
						children: "changes auto-reload on /reload or new session"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, {
						variant: "ghost",
						icon: "↺",
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "merged context preview" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									style: {
										fontFamily: F.mono,
										fontSize: 10.5,
									...
									children: "Total tokens consumed by context files:"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									].map(([name, tok, c]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										style: {
											display: "flex",
											justifyContent: "space-between",
											marginBottom: 5
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "reload trigger" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									style: {
										fontFamily: F.mono,
										fontSize: 10.5,
									...
									children: "Context is re-injected:"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									style: {
										fontFamily: F.mono,
...
function ThemeCard({ theme, active, onSelect }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: theme.preview.map((c, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Swatch, { color: c }, i))
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			style: {
				padding: "8px 10px",
				background: T.bgPanel,
...
function TokenRow({ name, value, preview }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			preview && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: {
				width: 16,
				height: 16,
				borderRadius: 3,
				background: preview,
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: [
										...
										"#febc2e",
										"#28c840"
									].map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: {
										width: 10,
										height: 10,
										borderRadius: "50%",
										background: c
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												...
												children: "refactor the auth module to use JWT"
											})]
											...
											children: ["I'll refactor the auth module…", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: {
												display: "inline-block",
												width: 7,
												height: 13,
												background: T.pi,
										...
										children: [
											...
											["tool", T.tool],
											["accent", T.pi]
										].map(([n, c]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											style: {
												display: "flex",
												alignItems: "center",
												gap: 6
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "surface tokens" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TokenRow, {
								name: "T.bg",
								value: "#0e0d0b",
								preview: "#0e0d0b"
							}),
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								style: { marginTop: 10 },
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "text tokens" })
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TokenRow, {
								name: "T.text",
								value: "#e8e0cc",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								style: { marginTop: 10 },
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "accent tokens" })
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TokenRow, {
								name: "T.pi",
								value: "#f0a45a",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								style: { marginTop: 10 },
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "border tokens" })
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TokenRow, {
								name: "T.border",
								value: "#2c2820",
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMain, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1 } }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Kbd, { children: "Ctrl+S" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						style: {
							fontFamily: F.mono,
							fontSize: 11,
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: "Self-contained .html with syntax highlighting"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, {
										variant: "outline",
										onClick: exportHtml,
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: "Raw session JSON — messages, tool calls, usage"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, {
										variant: "outline",
										onClick: exportJson,
...
//#endregion
//#region src/screens/ToolInspector.tsx
function LineNo({ n, highlight }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		style: {
			padding: "0 10px",
			fontFamily: F.mono,
			fontSize: 11.5,
			lineHeight: "20px",
			color: highlight ? T.pi : T.textFaint,
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						children: toolCall?.tool ?? "none selected"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1 } }),
					toolCall && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Pill, {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", {
								...
								children: toolCall?.args ?? "(no tool selected)"
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							style: {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							style: {
								fontFamily: F.mono,
								fontSize: 11,
								color: toolCall?.status === "err" ? T.err : T.ok,
								marginBottom: 14
							},
							children: toolCall?.output ?? "(no output yet)"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							style: {
								fontFamily: F.mono,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: toolCall ? `tool_execution_start → running → tool_execution_end` : "(no timeline available)"
						}),
						toolCalls.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							style: {
								fontFamily: F.mono,
								fontSize: 10,
								color: T.textFaint,
							...
							children: toolCalls.map((tc, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								title: tc.tool,
								onClick: () => {},
								style: {
									width: 26,
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: toolCall?.tool ?? "No tool call selected"
							}),
							toolCall && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pill, {
								color: T.tool,
								bg: `${T.tool}15`,
								border: `${T.tool}40`,
								children: toolCall.tool
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1 } })
						]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: toolCalls.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								flex: 1,
								display: "flex",
								alignItems: "center",
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: "No tool calls in this session yet"
							})]
							...
							children: [...Array(20)].map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LineNo, {
								n: i + 1,
								highlight: i === 5
							}, i))
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DiffLine, {
									kind: " ",
									text: `tool: ${toolCall?.tool ?? ""}`
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DiffLine, {
									kind: " ",
									text: `args: ${toolCall?.args ?? ""}`
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DiffLine, {
									kind: " ",
...
var TRANSCRIPT = [
	...
	{
		turn: "pi",
		text: "Starting JWT migration. Reading current auth implementation…",
		tool: "read_file",
		toolStatus: "done"
	},
	{
		turn: "pi",
		text: "Found session-based auth in src/auth/. I'll replace the cookie store with a signed JWT approach.",
		tool: null,
		toolStatus: null
	},
	{
		turn: "pi",
		text: "Writing jwt.ts helper with sign/verify wrappers…",
		tool: "str_replace_based_edit_tool",
		toolStatus: "done"
	},
	{
		turn: "pi",
		text: "Updating authMiddleware to validate Bearer tokens…",
		tool: "str_replace_based_edit_tool",
		toolStatus: "running"
	}
];
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						children: "JWT auth refactor · tool call 14 of ~22"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1 } }),
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: TRANSCRIPT.map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: item.turn === "user" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								style: {
									display: "flex",
									flexDirection: "column",
									alignItems: "flex-end"
								...
								item.tool && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									style: {
										display: "flex",
										alignItems: "center",
										gap: 8,
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [item.text, i === TRANSCRIPT.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: {
										display: "inline-block",
										width: 7,
										height: 13,
										background: T.pi,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: "Steering messages are injected into the next assistant turn without starting a new session."
								})
							]
						})
					]
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionLabel, { children: "progress" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									style: {
										display: "flex",
										gap: 3,
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: "14 / ~22 tool calls · approx 30% done"
								})
							]
						})
					]
...
//#endregion
//#region src/data/featureStatus.ts
var PI_FEATURES = [
	{
		id: "chat-prompt",
		category: "Chat",
		name: "Send prompt",
		description: "Send a user message to pi",
		status: "implemented"
	},
	{
		id: "chat-stream",
		...
		description: "Real-time streaming of assistant text",
		status: "implemented"
	},
	{
		id: "chat-tool-calls",
		...
		description: "Show read/bash/edit/write/grep/find/ls calls inline",
		status: "implemented"
	},
	{
		id: "chat-abort",
		category: "Chat",
		name: "Abort (Ctrl+C)",
		description: "Send SIGINT to stop current operation",
		status: "implemented"
	},
	{
		id: "chat-steer",
		category: "Chat",
		name: "Steer mid-task",
		description: "Inject steering message during run",
		status: "implemented"
	},
	{
		id: "chat-followup",
		...
		description: "Queue follow-up message after agent finishes",
		status: "implemented"
	},
	{
		id: "chat-multiline",
		...
		description: "Shift+Enter for newlines in composer",
		status: "implemented"
	},
	{
		id: "chat-file-ref",
		...
		description: "Fuzzy-search project files with @ in editor",
		status: "not-possible",
		notes: "Terminal-specific feature (fuzzy overlay in TUI)"
	},
	{
		id: "chat-path-complete",
		category: "Chat",
		name: "Tab path completion",
		description: "Tab to complete file paths in editor",
		status: "not-possible",
		notes: "Terminal readline feature"
	},
	{
		id: "chat-image-paste",
		category: "Chat",
		name: "Image paste",
		description: "Paste images via Ctrl+V into context",
		status: "not-possible",
		notes: "Terminal drag-and-drop; RPC images field available but no file picker in UI"
	},
	{
		id: "chat-shell-bang",
		category: "Chat",
		name: "Shell command (!cmd)",
		description: "Run shell command and send output to model",
		status: "not-possible",
		notes: "Terminal-specific shorthand; use bash RPC instead"
	},
	{
		id: "chat-ext-editor",
		category: "Chat",
		name: "External editor (Ctrl+G)",
		description: "Open $VISUAL/$EDITOR to compose message",
		status: "not-possible",
		notes: "Terminal feature; not applicable to GUI textarea"
	},
	{
		id: "model-switch",
		category: "Model",
		name: "Switch model (/model)",
		description: "Pick any configured provider/model",
		status: "implemented"
	},
	{
		id: "model-cycle",
		category: "Model",
		name: "Cycle favorites (Ctrl+P)",
		description: "Cycle through starred models",
		status: "implemented"
	},
	{
		id: "model-thinking",
	...
	},
	{
		...
		description: "Read/write AGENTS.md context files",
		status: "implemented"
	},
	{
		id: "context-system-md",
		category: "Context",
		name: "SYSTEM.md editor",
		description: "Read/write SYSTEM.md prompt override",
		status: "implemented"
	},
	{
		id: "context-reload",
	...
	},
	{
		...
		description: "pi install npm:/git:/local:/url:",
		status: "implemented"
	},
	{
		id: "pkg-uninstall",
	...
	},
	{
		...
		description: "Enable/disable per-package resources",
		status: "not-yet"
	},
	{
		id: "custom-themes",
		...
		name: "Theme gallery",
		description: "Browse and apply built-in and installed themes",
		status: "partial",
		notes: "Gallery shown; load installed themes from FS"
	},
	{
		id: "custom-prompts",
		category: "Customization",
	...
	},
	{
		id: "auth-logout",
		category: "Auth",
		name: "Provider logout (/logout)",
		description: "Remove OAuth/key credentials",
		status: "not-yet"
	},
	{
		id: "mode-interactive",
		category: "Mode",
		name: "Interactive (RPC)",
		description: "Full chat UI over pi --mode rpc",
		status: "implemented"
	},
	{
		id: "mode-print",
		category: "Mode",
		name: "Print/JSON mode",
		description: "pi -p \"query\" one-shot output",
		status: "not-possible",
		notes: "piui is an interactive UI; -p mode is terminal/script only"
	},
	{
		id: "mode-sdk",
		category: "Mode",
		name: "SDK mode",
		description: "Embed pi in Node.js apps",
		status: "not-possible",
		notes: "piui uses subprocess RPC instead of direct SDK"
	}
];
//#endregion
//#region src/screens/FeatureStatus.tsx
var STATUS_COLORS = {
	implemented: T.ok,
	partial: T.warn,
	"not-yet": T.pi,
...
function FeatureRow({ feature }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatusDot, { status: feature.status }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			style: {
				flex: 1,
				minWidth: 0
			},
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						children: STATUS_LABELS[feature.status]
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					style: {
				...
				feature.notes && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					style: {
						fontFamily: F.mono,
						fontSize: 10.5,
						color: T.textFaint,
...
function FeatureStatus() {
	const [query, setQuery] = (0, import_react.useState)("");
	const [collapsedCategories, setCollapsedCategories] = (0, import_react.useState)(/* @__PURE__ */ new Set());
	const filtered = (0, import_react.useMemo)(() => {
		if (!query) return PI_FEATURES;
		const q = query.toLowerCase();
		return PI_FEATURES.filter((f) => f.name.toLowerCase().includes(q) || f.description.toLowerCase().includes(q) || f.category.toLowerCase().includes(q));
	}, [query]);
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								...
								children: [PI_FEATURES.length, " features tracked"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1 } }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, {
								variant: "ghost",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SummaryPill, {
								status: "implemented",
								count: counts.implemented
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SummaryPill, {
								status: "partial",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SummaryPill, {
								status: "not-yet",
								count: counts["not-yet"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SummaryPill, {
								status: "not-possible",
								count: counts["not-possible"]
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [categorized.size === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					style: {
						fontFamily: F.mono,
						fontSize: 12,
						color: T.textFaint,
					...
					children: "No features match your search."
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						}), !isCollapsed && features.map((f) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FeatureRow, { feature: f }, f.id))]
					}, category);
				})]
			})]
		})]
...
function Settings() {
	...
	const handleThinking = (level) => {
		setThinkingLevel(level);
		rpc.setThinkingLevel(level);
	};
	const handleSteeringMode = (mode) => {
		setSteeringMode(mode);
		rpc.setSteeringMode(mode);
	};
	const handleFollowUpMode = (mode) => {
		setFollowUpMode(mode);
		rpc.setFollowUpMode(mode);
	};
	const handleAutoCompaction = (v) => {
		setAutoCompaction(v);
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMain, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					!isPiAvailable && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						style: {
							fontFamily: F.mono,
							fontSize: 10.5,
							color: T.textMuted
						},
						children: "(pi not running — controls rendered but inactive)"
					})
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				style: {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeader, { title: "Thinking Level" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Control how much reasoning budget pi uses before responding."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						style: {
							display: "flex",
						...
						children: THINKING_LEVELS.map((level) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToggleOption, {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeader, { title: "Steering Mode" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						style: {
							fontFamily: F.sans,
							fontSize: 12,
						...
						children: "How steering messages are delivered when pi is running."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						style: {
							display: "flex",
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToggleOption, {
							label: "Deliver all steering messages",
							value: "all",
							selected: steeringMode === "all",
							onClick: () => handleSteeringMode("all")
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToggleOption, {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeader, { title: "Follow-up Mode" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						style: {
							fontFamily: F.sans,
							fontSize: 12,
						...
						children: "How queued follow-up messages are processed after pi finishes."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						style: {
							display: "flex",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeader, { title: "Auto-Compaction" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						style: {
							fontFamily: F.sans,
							fontSize: 12,
						...
						children: "Automatically summarize older context when approaching the token limit."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						style: {
							display: "flex",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeader, { title: "Customize" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Btn, {
						variant: "outline",
						icon: "◉",
						onClick: () => navigate("theme"),
						children: "Open Theme Customizer"
					})
				]
			})]
		})]
...
//#endregion
//#region src/screens/CommandPalette.tsx
var BUILTIN_COMMANDS = [
	{
		cmd: "/commit",
		desc: "Generate a conventional commit from staged diff",
		category: "git"
	},
	{
		cmd: "/pr",
		desc: "Write a GitHub pull request description",
		category: "git"
	},
	{
		cmd: "/plan",
		desc: "Create a multi-step execution plan",
		category: "planning"
	},
	{
		cmd: "/review",
		desc: "Code review with actionable suggestions",
		category: "review"
	},
	{
		cmd: "/test",
		desc: "Generate test cases for selected code",
		category: "code"
	},
	{
		cmd: "/docs",
		desc: "Add JSDoc / docstrings to functions",
		category: "code"
	},
	{
		cmd: "/explain",
		desc: "Explain code or error in plain language",
		category: "code"
	},
	{
		cmd: "/refactor",
		desc: "Refactor selected code with reasoning",
		category: "code"
	},
	{
		cmd: "/share",
	...
	{
		cmd: "/context",
		desc: "Open context file editor",
		category: "session"
	},
	{
		cmd: "/steer",
		desc: "Inject steering message into current run",
		category: "session"
	},
	{
		cmd: "/abort",
		desc: "Abort current run",
		category: "session"
	},
	{
		cmd: "/new",
	...
	{
		cmd: "/theme",
		desc: "Open theme customizer",
		category: "settings"
	},
	{
		cmd: "/packages",
		desc: "Browse and manage packages",
		category: "settings"
	},
	{
		cmd: "/prompts",
		desc: "Manage prompt templates",
		category: "settings"
	},
	{
		cmd: "/features",
		desc: "View feature status dashboard",
		category: "settings"
	},
	{
		cmd: "/settings",
	...
	{
		cmd: "/inspect",
		desc: "Inspect last tool call",
		category: "debug"
	},
	{
		cmd: "/tree",
		desc: "View session tree navigator",
		category: "debug"
	}
];
var categoryColor = {
...
function CommandPalette() {
	...
	const allCommands = (0, import_react.useMemo)(() => {
	...
	const filtered = (0, import_react.useMemo)(() => {
		...
		const q = query.toLowerCase();
		return allCommands.filter((c) => c.cmd.toLowerCase().includes(q) || c.desc.toLowerCase().includes(q));
	}, [allCommands, query]);
	(0, import_react.useEffect)(() => {
		setSelectedIdx(0);
	}, [query]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			style: {
				...
				overflow: "hidden",
				border: `1px solid ${T.borderHi}`,
				boxShadow: `0 24px 64px rgba(0,0,0,0.5), 0 0 0 1px ${T.piBg}`
			},
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [filtered.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					}), filtered.map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pill, {
								color: categoryColor[item.category] || T.textFaint,
								bg: "transparent",
								border: T.border,
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [filtered.length, " commands"] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { flex: 1 } }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "from packages, built-ins, and prompt templates" })
					]
				})
			]
		})
...
//#endregion
//#region src/screens/PermissionPrompt.tsx
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: "Approve once, always, or deny this request."
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						style: {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Kbd, { children: "y" }),
							" allow once",
...
function AppRouter() {
	...
	(0, import_react.useEffect)(() => {
		...
		const cleanupNav = window.pi?.onNavigate((s) => navigate(s));
		const cleanupOverlay = window.pi?.onOverlay((o) => openOverlay(o));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			{
				chat: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MainChat, {}),
				onboarding: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Onboarding, {}),
				tree: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SessionTree, {}),
				model: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ModelPicker, {}),
				packages: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Packages, {}),
				"ext-detail": /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExtensionDetail, {}),
				prompts: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PromptTemplates, {}),
				context: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ContextEditor, {}),
				theme: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeCustomizer, {}),
				share: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShareExport, {}),
...
function App() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NavProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppRouter, {}) });
}
//#endregion
//#region src/main.tsx
