// Onboarding — first-run welcome + install + provider auth.
// Terminal-style stepped walkthrough.
...
function InstallBlock({ active, cmd }) {
  return (
    <div style={{
      border: `1px solid ${active ? T.piBorder : T.border}`,
      borderRadius: 6, background: T.bgInput,
      boxShadow: active ? `0 0 0 3px ${T.piBg}` : 'none',
      overflow: 'hidden',
    }}>
      ...
      <div style={{ padding: '14px 16px', fontFamily: F.mono, fontSize: 13.5,
    ...
    <PiWindow title="pi · first run"
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column',
        ...
        <div style={{ padding: '52px 64px 24px', display: 'flex', gap: 32, alignItems: 'center' }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 14 }}>
              <span style={{ fontFamily: F.mono, fontSize: 96, fontWeight: 500,
                color: T.pi, lineHeight: 1, letterSpacing: -2 }}>π</span>
              <div>
                <div style={{ fontFamily: F.sans, fontSize: 32, fontWeight: 500,
                  color: T.text, letterSpacing: -0.5 }}>
                  There are many agent harnesses.
                </div>
                <div style={{ fontFamily: F.sans, fontSize: 32, fontWeight: 500,
                  color: T.pi, letterSpacing: -0.5 }}>
                  This one is yours.
                </div>
              </div>
            </div>
            <div style={{ fontFamily: F.mono, fontSize: 13, color: T.textDim,
              marginTop: 18, maxWidth: 640, lineHeight: 1.6 }}>
        ...
        <div style={{ padding: '0 64px 48px', display: 'flex', gap: 32, flex: 1 }}>
          ...
          {/* left: providers */}
          <div style={{ flex: 1.4 }}>
            <div style={{ fontFamily: F.mono, fontSize: 12, color: T.textDim,
              marginBottom: 14 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 7 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8,
                padding: '8px 4px 0', fontFamily: F.mono, fontSize: 11, color: T.textMuted }}>
                <span style={{ color: T.textFaint }}>+ 11 more:</span>
                <span>Azure · Bedrock · Mistral · Cerebras · xAI · Hugging Face · Kimi · MiniMax · …</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8,
                padding: '6px 4px 0', fontFamily: F.mono, fontSize: 11, color: T.textMuted }}>
                <span style={{ color: T.textFaint }}>custom:</span>
                <span style={{ color: T.info }}>~/.pi/models.json</span>
                <span style={{ color: T.textFaint }}>· bring any OpenAI-compatible endpoint</span>
              </div>
            </div>
          </div>

          {/* right: install reference */}
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8,
                ...
                {[
                  ...
                  <div key={k} style={{ padding: '8px 10px', borderRadius: 5,
        ...
        {/* footer */}
        <div style={{ padding: '14px 64px 22px', display: 'flex', alignItems: 'center', gap: 12,
          ...
          <Btn variant="primary" kbd="↵">Continue →</Btn>
        </div>
      </div>
    </PiWindow>
  );
